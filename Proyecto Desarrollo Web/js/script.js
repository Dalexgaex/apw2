...
function getRandomQuestions() {
    // Obtener un arreglo aleatorio de índices únicos
    let randomIndices = [];
    ...
    // Crear un arreglo de preguntas aleatorias
    let randomQuestions = [];
...
function showResult() {
    ...
    if (userScore > 3) { 
        let scoreTag = '<span> ¡Felicidades! 🎉 Tienes <p>' + userScore + '</p> de <p>' + selectedQuestions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
    } else if (userScore > 1) { 
        let scoreTag = '<span> ¡Muy bien! 😎 Tienes <p>' + userScore + '</p> de <p>' + selectedQuestions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
    } else { 
        let scoreTag = '<span> ¡Fallaste! 😐 Tienes <p>' + userScore + '</p> de <p>' + selectedQuestions.length + '</p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
